...
request.setAttribute("DIC_SUB_STATE",MfConstant.DIC_ROLE_STATE);
...
<html>
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>js/base/subsystem/app.js"></script>
    <script type="text/javascript">
    	//常量信息
    	/**角色状态*/
    	var DIC_SUB_STATE = "${DIC_SUB_STATE}";
