...
request.setAttribute("DIC_POWER_STATE",MfConstant.DIC_POWER_STATE);
%>
...
<html>
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>js/base/power/app.js"></script>
    <script type="text/javascript">
    	var DEFAULT_ROOT_UUID = "${DEFAULT_ROOT_UUID}";
    	var DIC_POWER_STATE = "${DIC_POWER_STATE}";
