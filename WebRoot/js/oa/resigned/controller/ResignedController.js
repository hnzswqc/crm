  ...
  //保存离职信息
   ...
   //关闭离职窗口
    ...
    reloadResignedGridPanelStore:function(data,text){
    	...
    	gridPanel.store.setProxy({
    		type: 'ajax',
            url: 'resigned/getResignedPage.do?resState='+DIC_RESIGNED_STATE_NO,
            extraParams:data,
            actionMethods: {
        		read: 'POST'
    		},
    ...
    onResignedExcelBtnClick:function(button, e, eOpts) {
    	...
    	var panel = Ext.getCmp("ResignedSearchFromPanel");
        if(panel.isHidden()){
        	window.location.href=extBasePath+"resigned/getDownResignedList.do?resState="+DIC_RESIGNED_STATE_NO;
        }else{
        	var param = panel.getValues(true);
        	window.location.href=extBasePath+"resigned/getDownResignedList.do?resState="+DIC_RESIGNED_STATE_NO+"&"+param;  
        }
        Ext.Msg.hide();
    },
    //设置选择的月份
