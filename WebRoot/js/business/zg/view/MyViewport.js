                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    icon: 'img/search.png',
                                    text: '高级查询',
                                    hidden:exists('BzShowSearchFormBtn_zg')
                                }
                            ]
                        },
                        {
                        ...
                        },
                        {
                            ...
                            margin: '0 2 2 2',
                            title: '制管工资',
                            store:Ext.create("Zg.store.ZgStore",{autoLoad:true}),
                            columns: [
                                {
		                            xtype: 'rownumberer',
		                            width: 39,
