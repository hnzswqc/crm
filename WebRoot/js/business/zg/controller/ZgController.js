...
Ext.define('Zg.controller.ZgController', {
    extend: 'Ext.app.Controller',

    //刷新按钮
    onZgReloadBtnClick: function(button, e, eOpts) {
		Ext.getCmp("BzGridPanel").store.reload();
    },
    //添加按钮
    onBzAddBtnClick: function(button, e, eOpts) {
    	  Ext.create("Zg.view.MyWindow",{title:'添加制管工资',icon:'img/add.png'}).show();
    },
    //修改按钮
    onBzUpdBtnClick: function(button, e, eOpts) {
        ...
        Ext.create("Zg.view.MyWindow",{title:'修改制管工资',icon:'img/update.png'}).show();
    ...
    onBzExportBtnClick: function(button, e, eOpts) {
        ...
        if(panel.isHidden()){
        	window.location.href=extBasePath+"zg/getDownZgList.do";
        }else{
        	var param = panel.getValues(true);
        	window.location.href=extBasePath+"zg/getDownZgList.do?"+param;  
        }
        Ext.Msg.hide();
  ...
  //设置界面属性显示隐藏属性
    ...
    onBzSearchBtnClick: function(button, e, eOpts) {
    	...
    	this.reloadBzGridPanelStore(searchForm.getValues(),'高级查询-制管工资');
    },
    //重置按钮
    onBzResetBtnClick: function(button, e, eOpts) {
    	...
    	Ext.getCmp("endDate_search").setValue("");
   	    this.reloadBzGridPanelStore(null,'制管工资');
    },
    //刷新数据
  ...
  //定时器,解决单击事件双击事件问题
   ...
   //用户双击事件
    ...
    onBzChoseUserBtnClick:function(button, e, eOpts) {
    	Ext.create("Zg.view.LoggingUserWindow",{"title":"双击选择员工","icon":"img/search.png"}).show();
    	
    },
    //选择产品按钮
    onBzChoseProductBtnClick:function(button, e, eOpts) {
    	Ext.create("Zg.view.ProductWindow",{"title":"双击选择产品","icon":"img/search.png"}).show();
    },
    //选择人员-刷新按钮
   ...
   //选择人员-保存按钮
    ...
    init: function(application) {
        this.control({
            "button[id=ZgReloadBtn]": {
                click: this.onZgReloadBtnClick
            },
            "button[id=BzAddBtn]": {
