...
Ext.define('Ext.ux.TabCloseMenu', {
     ...
     * 关闭图标
     */
    closeTabTextIcon:'img/cross.png',
     ...
     * 关闭图标
     */
    closeOthersTabsTextIcon:'img/cross.png',
     ...
     * 关闭图标
     */
    closeAllTabsTextIcon:'img/cross.png',
    ...
    onContextMenu : function(event, target){
        ...
        currentItem=me.tabPanel.getComponent(index);
        ...
        if (!me.menu) {
            ...
            if (me.showCloseOthers) {
                items.push({
                    ...
                    icon: me.closeOthersTabsTextIcon,
                    scope: me,
